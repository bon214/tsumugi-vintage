...
(function () {
  ...
  var ADM = {
    ...
    publicationClear: ["No publication or sales issues need attention.", "公開・販売状態に要確認の項目はありません。"],
    publicationCount: ["{n} items need publication or sales checks", "公開・販売状態の確認が必要な項目が{n}件あります"],
    publicationTotal: ["{n} items", "{n}件"],
    notifyPublication: ["Notify me about publication or sales issues", "公開・販売状態の不備を通知する"],
    issueStock: ["Published with no available stock", "在庫0点・販売状態を確認"],
    issueImage: ["Primary image missing", "メイン画像が未設定"],
    issueRequired: ["Required product information missing", "商品情報に未入力・不備あり"],
    issueImageAlt: ["Image description missing", "画像の説明が未入力"],
    issueHero: ["Featured content", "注目コンテンツ"],
    issueReference: ["Linked content is missing", "参照先が未設定・削除済み"],
    search:          ["Search", "検索"],
    save:            ["Save", "保存"],
